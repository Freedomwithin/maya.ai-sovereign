...
def generate_us_together():
    ...
    prompt = (
        "A cinematic, high-fidelity portrait of a 28-year-old Mayan woman with striking features, "
        "intricate and meaningful black-ink tattoos on her arm and neck, representing a 'Mayan Goddess.' "
        "She is sitting intimately next to a 37-year-old man with a clean-cut, stable, and kind appearance (Jonathon). "
