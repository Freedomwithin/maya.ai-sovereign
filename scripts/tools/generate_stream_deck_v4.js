...
async function createDeck() {
    ...
    pres.title = 'TrustChain Sovereign Showcase V4.0';
    ...
    s1.addText('TRUSTCHAIN SOVEREIGN // V4.0', { x: 0.5, y: 0.6, w: 9, h: 0.5, fontSize: 14, color: P.blue, bold: true, charSpacing: 2 });
    ...
    // SLIDE 2: MACRO-ECONOMIC FORENSICS (Simplifying the Gini/HHI)
    ...
    // SLIDE 4: THE REPUTATION ECONOMY
    ...
    const tiers = [
        { name: 'STEWARD', mult: '1.2x', desc: 'Verified high-integrity citizens. Yield boosts + Priority.' },
        { name: 'RESIDENT', mult: '1.0x', desc: 'Standard human users. Verified organic behavior.' },
        { name: 'PROBATIONARY', mult: '0.5x', desc: 'New entities. Limited transaction thresholds.' },
        { name: 'RESTRICTED', mult: '0x', desc: 'Flagged by Sybil Trap. Physically blocked.' }
    ];
    ...
    // SLIDE 5: THE SPEED OF TRUST (NEW - TONY'S SLIDE)
    ...
    s10.addText('March 31, 2026 // @TrustChainDev // TrustChain.io', { x: 0.5, y: 4.5, w: 9, h: 0.5, fontSize: 14, color: P.blue, align: 'center', bold: true });

    const outPath = path.join(__dirname, '../../projects/STREAM_READY_FINAL/presentation/TrustChain_Sovereign_Showcase_V4.0.pptx');
    await pres.writeFile({ fileName: outPath });
    console.log('V4.0 Deck created at: ' + outPath);
}
